...
<body>
   <div class="container">
      <aside>
        ...
        <div class="top">
                <div class="logo">
                    ...
                    <span class=""><i class="ri-fire-line"></i>Eko Response</span>
                    </a> 
                </div>
         ...
         <!-- end top -->
          <div class="sidebar">
           ...
           <a href="update_profile.php?id=<?php echo $userdata['user_id']; ?>" class="active">
           ...
           <a href="#">
              <span class="material-symbols-sharp">local_police </span>
              <h3>Police Station</h3>
           </a>
           <a href="#">
              <span class="material-symbols-sharp">emergency </span>
              <h3>Hospitals</h3>
           </a>
           <a href="#">
      ...
      <main>
           ...
           <div class="date">
           <?php
            $d=strtotime("10:30pm May 31 2024");
        ...
        <div class="insights">
           ...
           <!-- end seling -->
              <!-- start expenses -->
              <div class="expenses">
                <span class="material-symbols-sharp">crisis_alert</span>
                <div class="middle">
                ...
                <small>Availabe in our database</small>
             </div>
            <!-- end seling -->
               <!-- start seling -->
               <div class="income">
   ...
   <div class="theme-toggler">
    ...
    <div class="profile">
       ...
       <div class="profile-photo">
         <img src="uploads/<?php echo $userdata['user_image'] ?>" class="img-fluid" alt="admin image">
       </div>
    </div>
</div>
  ...
  <div class="recent_updates">
   ...
   <div class="updates">
      <div class="update">
        ...
        <div class="message">
           <p><b><?php echo $firstname?></b> Submited an Emergency Form</p>
        </div>
      </div>
