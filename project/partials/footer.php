                ...
                <div class="container-fluid" >
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="#" style="text-decoration: none;" class="text-light">Services</a></li>
                            </ul>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 text-md-right">
                            <a href="linkedin.com" class="btn btn-link text-light"><i class="fab fa-linkedin fa-2x" aria-label="LinkedIn"></i></a>
                            <a href="facebook.com" class="btn btn-link text-light"><i class="fab fa-facebook fa-2x" aria-label="Facebook"></i></a>
                            <a href="twitter.com" class="btn btn-link text-light"><i class="fab fa-twitter fa-2x" aria-label="Twitter"></i></a>
                        </div>
                    </div>
                </div>
