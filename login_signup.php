...
<div class="user-modal">
		<div class="user-modal-container">
			<?php
			if (!empty($_SESSION['user_errormessage'])) {
				echo '<div class="alert alert-danger">' . htmlspecialchars($_SESSION['user_errormessage']) . '</div>';
				unset($_SESSION['user_errormessage']);
			}
			if (!empty($_SESSION['errormsg'])) {
				echo '<div class="alert alert-danger">' . htmlspecialchars($_SESSION['errormsg']) . '</div>';
...
<!-- partial -->
  ...
  <script>
    $(function(){
      ...
      if(!stateId || stateId === "select"){ $("#lga").hide().empty(); return; }
      $.ajax({
        url:"server.php",
        method:"post",
        data:{ state: stateId },
